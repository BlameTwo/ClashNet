...
//using :https://github.com/tiagonmas/Windows-Loopback-Exemption-Manager.git


namespace Clash.CoreNet.LookBackExempt.Toolkit;
public class LoopUtil
{
    ...
    public bool SaveLoopbackState(List<AppContainer> list)
    {
